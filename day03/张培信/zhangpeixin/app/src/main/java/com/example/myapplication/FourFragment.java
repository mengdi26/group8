...
public class FourFragment extends Fragment {
    ...
    private ArrayList<Redainbean.DataBean.ListBean> list;
    ...
    private void initData() {
        new Retrofit.Builder()
                ...
                .subscribe(new Observer<Redainbean>() {
                    ...
                    @Override
                    public void onNext(Redainbean shafaBean) {
                        List<Redainbean.DataBean.ListBean> list = shafaBean.getData().getList();
                        list.addAll(list);
    ...
    private void initView(@NonNull final View itemView) {
        ...
        list = new ArrayList<>();
        myadapter1 = new Myadapter1(list, getActivity());
