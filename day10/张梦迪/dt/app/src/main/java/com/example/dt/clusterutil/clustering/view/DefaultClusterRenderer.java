...
package com.example.dt.clusterutil.clustering.view;
...
import com.example.dt.clusterutil.Cluster;
import com.example.dt.clusterutil.ClusterItem;
import com.example.dt.clusterutil.ClusterManager;
import com.example.dt.clusterutil.MarkerManager;
import com.example.dt.clusterutil.projection.Point;
import com.example.dt.clusterutil.projection.SphericalMercatorProjection;
import com.example.dt.clusterutil.ui.IconGenerator;
...
import static com.example.dt.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.example.dt.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.example.dt.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        com.example.dt.clusterutil.ui.SquareTextView squareTextView =
                new com.example.dt.clusterutil.ui.SquareTextView(context);
