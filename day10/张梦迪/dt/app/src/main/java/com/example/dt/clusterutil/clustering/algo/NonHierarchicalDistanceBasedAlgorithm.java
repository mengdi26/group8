...
package com.example.dt.clusterutil.clustering.algo;


import com.baidu.mapapi.model.LatLng;
import com.example.dt.clusterutil.Cluster;
import com.example.dt.clusterutil.ClusterItem;
import com.example.dt.clusterutil.projection.Bounds;
...
import com.example.dt.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.example.dt.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.example.dt.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.dt.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.example.dt.clusterutil.clustering.algo
