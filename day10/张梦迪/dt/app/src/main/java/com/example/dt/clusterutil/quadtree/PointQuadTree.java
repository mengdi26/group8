...
package com.example.dt.clusterutil.quadtree;
...
public class PointQuadTree<T extends PointQuadTree.Item> {
    ...
    public boolean remove(T item) {
        com.example.dt.clusterutil.projection.Point point = item.getPoint();
        if (this.mBounds.contains(point.x, point.y)) {
    ...
    public interface Item {
        ...
        public com.example.dt.clusterutil.projection.Point getPoint();
