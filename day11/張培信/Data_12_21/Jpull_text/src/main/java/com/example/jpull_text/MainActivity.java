...
import static com.example.jpull_text.TagAliasOperatorHelper.ACTION_ADD;
import static com.example.jpull_text.TagAliasOperatorHelper.ACTION_CLEAN;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData() {
        list.add(R.drawable.fgf);
        list.add(R.drawable.fgf);
        list.add(R.drawable.fgf);
        list.add(R.drawable.fgf);
        list.add(R.drawable.fgf);
        lista.add(R.drawable.sss);
        lista.add(R.drawable.sss);
        lista.add(R.drawable.sss);
        lista.add(R.drawable.sss);
        lista.add(R.drawable.sss);
