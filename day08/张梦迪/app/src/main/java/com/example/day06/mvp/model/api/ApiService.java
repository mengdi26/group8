package com.example.day06.mvp.model.api;
...
public interface ApiService {
    ...
    @GET
    <T>
    Observable<ResponseBody> requestGetData(@Url String url, @HeaderMap HashMap<String, T> headers);
    ...
    @POST
    @Multipart
    Observable<RequestBody> uploadFile(@Url String url, @Part MultipartBody.Part part);
