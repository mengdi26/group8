...
package com.example.data_12_21.mapapi.clusterutil.clustering.algo;
...
import com.example.data_12_21.mapapi.clusterutil.projection.Bounds;
...
import com.example.data_12_21.mapapi.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.example.data_12_21.mapapi.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.example.data_12_21.mapapi.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.data_12_21.mapapi.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.example.data_12_21.mapapi.clusterutil.clustering.algo
