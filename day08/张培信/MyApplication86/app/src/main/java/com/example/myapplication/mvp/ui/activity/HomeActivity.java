...
import com.example.myapplication.engine.adapter.HomeActVpAdapter;
import com.example.myapplication.manager.ContainManager;
import com.example.myapplication.manager.ThreadPoolManager;
import com.example.myapplication.mvp.ui.fragment.CollectFragment;
...
public class HomeActivity extends BaseActivity {
    ...
    private int[] mTabs = {R.string.home_tab_title, R.string.collect_tab_title,R.drawable.gg,R.string.kk,R.string.uu};
